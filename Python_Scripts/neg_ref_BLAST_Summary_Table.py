...
filtered_BLAST_Summary_Table1['BLAST_Sequence'] = filtered_BLAST_Summary_Table1['BLAST_Sequence'].str.wrap(15)

filtered_BLAST_Summary_Table1['Query_Coverage'] = filtered_BLAST_Summary_Table1['Query_Coverage'].astype('int')

#filtered_BLAST_Summary_Table2 = filtered_BLAST_Summary_Table1[filtered_BLAST_Summary_Table1['Query_Coverage'] > 80]

filtered_BLAST_Summary_Table1.to_csv(args.BLAST_summary_table)

Cluster_Summary_Table = pd.read_csv(args.cluster_summary)

Complete_Summary_Table = pd.merge(Cluster_Summary_Table, filtered_BLAST_Summary_Table1, on='SeqID')
